...
{
  "devDependencies": {
    "qq-theme-framework": "Tangjj1996/qq-theme-chalk#{id}/head"
  }
}
```
...
When submitting your contribution, a CLA (Contributor License Agreement) bot will come by to verify that you signed the [CLA](https://cla.js.foundation/Tangjj1996/qq-theme-chalk).
